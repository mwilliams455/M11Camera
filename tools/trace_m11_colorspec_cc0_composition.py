...
def main():
 ...
 L += ['## Calibration object raw-reference note','',
       ...
       '- Known materialization later copies calibration `+0x40` and `+0x70` as CM1/CM2 records. This tracer does not assume names for adjacent fields until helper semantics establish them.','']
